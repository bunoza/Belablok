...
Ova Pravila o privatnosti opisuju naša pravila i postupke o prikupljanju, korištenju i otkrivanju vaših podataka kada koristite uslugu i govore vam o vašim pravima na privatnost i kako vas zakon štiti.

Vaše osobne podatke koristimo za pružanje i poboljšanje usluge. Korištenjem usluge pristajete na prikupljanje i korištenje informacija u skladu s ovom Politikom privatnosti. Ova Pravila privatnosti izrađena su uz pomoć Generatora pravila privatnosti.
...
Prijava se odnosi na Bela Blok, softverski program koji osigurava Društvo.

Tvrtka (u ovom se Ugovoru naziva "Tvrtka", "Mi", "Nas" ili "Naš") odnosi se na Bela Blok.
...
Pružatelj usluga označava svaku fizičku ili pravnu osobu koja obrađuje podatke u ime Društva. Odnosi se na tvrtke treće strane ili pojedince zaposlene u Tvrtki za olakšavanje Usluge, pružanje Usluge u ime Tvrtke, pružanje usluga povezanih s Uslugom ili pomoć Društvu u analizi korištenja Usluge.
...
Podaci prikupljeni tijekom korištenja aplikacije
Tijekom korištenja naše aplikacije, kako bismo pružili značajke naše aplikacije, možemo prikupljati, uz vaše prethodno dopuštenje:

Podaci o vašoj lokaciji
Ove informacije koristimo za pružanje značajki naše usluge, za poboljšanje i prilagodbu naše usluge. Podaci se mogu učitati na poslužitelje Društva i/ili poslužitelje Davatelja usluga ili se mogu jednostavno pohraniti na Vaš uređaj.

Možete omogućiti ili onemogućiti pristup ovim informacijama u bilo kojem trenutku, putem postavki Vašeg uređaja.
...
S drugim korisnicima: kada dijelite osobne podatke ili na drugi način komunicirate na javnim mjestima s drugim korisnicima, takve informacije mogu vidjeti svi korisnici i mogu se javno distribuirati vani.
...
Tvrtka će zadržati Vaše osobne podatke samo onoliko dugo koliko je potrebno za svrhe navedene u ovoj Politici privatnosti. Zadržat ćemo i koristiti vaše osobne podatke u mjeri u kojoj je to potrebno za poštivanje naših zakonskih obveza (na primjer, ako smo dužni zadržati vaše podatke kako bismo bili u skladu s primjenjivim zakonima), rješavanje sporova i provođenje naših pravnih ugovora i politika.
...
Imate pravo izbrisati ili zatražiti da vam pomognemo u brisanju osobnih podataka koje smo prikupili o vama.

Naša Vam usluga može dati mogućnost brisanja određenih informacija o Vama unutar Usluge.

Svoje podatke možete ažurirati, izmijeniti ili izbrisati u bilo kojem trenutku tako da se prijavite na svoj račun, ako ga imate, i posjetite odjeljak postavki računa koji vam omogućuje upravljanje vašim osobnim podacima. Također nas možete kontaktirati kako biste zatražili pristup, ispravak ili brisanje bilo kojih osobnih podataka koje ste nam dostavili.

Imajte na umu, međutim, da ćemo možda trebati zadržati određene podatke kada za to imamo zakonsku obvezu ili zakonsku osnovu.
...
Provedba zakona
Pod određenim okolnostima, od Društva se može tražiti da otkrije Vaše osobne podatke ako to bude potrebno, a na to zahtijeva zakon ili kao odgovor na valjane zahtjeve javnih tijela (npr. suda ili vladine agencije).
...
Privatnost djece
Naša usluga se ne obraća nikome mlađem od 13 godina. Ne prikupljamo svjesno osobne podatke od bilo koga mlađeg od 13 godina. Ako ste roditelj ili skrbnik i svjesni ste da nam je vaše dijete dalo osobne podatke, molimo vas Kontaktirajte nas. Ako postanemo svjesni da smo prikupili osobne podatke od bilo koga mlađeg od 13 godina bez provjere pristanka roditelja, poduzimamo korake za uklanjanje tih informacija s naših poslužitelja.

Ako se moramo osloniti na privolu kao pravnu osnovu za obradu vaših podataka, a vaša država zahtijeva privolu roditelja, možemo zatražiti privolu vašeg roditelja prije nego što prikupimo i upotrijebimo te podatke.
